    ...
    return (
        <Layout className='layout'>
            ...
            <Content className='content'>
                ...
                <br></br>
                <p>I'd also like to thank all the other creators of the various other channels which created ambient videos as well as the creators of React Leaflet, Leaflet for their awesome libraries and the creators of Waifu2K for allowing a brilliant upscale of the original map.</p>
            </Content>
